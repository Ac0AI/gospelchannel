...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      // Canonical: redirect www → apex (root path)
      {
        source: "/",
        has: [{ type: "host", value: "www.gospelchannel.com" }],
        destination: "https://gospelchannel.com/",
        permanent: true,
      },
      // Canonical: redirect www → apex (all other paths)
      {
        source: "/:path+",
        has: [{ type: "host", value: "www.gospelchannel.com" }],
        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://eu.i.posthog.com https://eu-assets.i.posthog.com https://api.posthog.com https://cloudflareinsights.com",
